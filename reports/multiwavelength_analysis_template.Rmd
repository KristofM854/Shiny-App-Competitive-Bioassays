...
/* GUI refresh: same Plex font / kable / details treatment as the
   single-wave template. Re-imported at the top of the multi-wave
   report so the parent's title and pre-plate sections (overview +
   wavelength-agreement summary) pick up the typography before any
   per-plate child include runs. */

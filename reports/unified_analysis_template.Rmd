...
```{r weight-comparison-plot, fig.width=12, fig.height=7, warning=FALSE, message=FALSE}
...
```{r weight-comparison-close, results='asis'}
if (multi_weight_mode && length(all_models) > 1) {
  cat(sprintf("\n\n*%s*\n\n",
...
```{r parallelism-assessment, results='asis'}
...
```{r tissue-normalization-traceability, results='asis'}
...
```{r exclusion-audit, results='asis'}

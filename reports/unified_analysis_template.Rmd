...
weight_label <- if (exists("model_stats") && !is.null(model_stats)) model_stats$weight_method %||% "unweighted" else "unweighted"
...
cat("\n\n")
cat(tr("ci_delta_method_note", lang))
cat("\n\n")
```
...
if (multi_weight_mode && length(all_models) > 1) {
  ...
  # --- Comparison table: R², RMSE, parameters ---
  ...
  names(comp_df) <- c(tr("qc_metric", lang), "R\u00B2", "RMSE",

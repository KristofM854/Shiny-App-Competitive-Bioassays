...
tryCatch({
  if (!drc_failed_completely && length(all_models) > 0) {
    ...
    section_start("Click to expand model stability assessment")
...
`r section_open("Click to expand sample results summary")`
...
if (exists("sample_results") && !is.null(sample_results) && nrow(sample_results) > 0) {
  ...
  if (nrow(sample_plot_data) > 0) {
    ...
    # Render plot (collapsible in HTML, plain heading in DOCX/PDF)
